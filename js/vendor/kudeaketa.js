...
/*Biedeoarentzako accordion-ak */
function bideoFuntzioa(id) {
	var x = document.getElementById(id);
	if (x.className.indexOf("bideontzia") == -1) {
	  x.className += " bideontzia";
	} else { 
	  x.className = x.className.replace(" bideontzia", "");
	}
  }
